...
occurrence_raster = raster(paste0(box_data_path, "occurrence.tif"))
writeRaster(occurrence_raster, paste0(here::here(), "/data/surface_water/occurrence.tif"), "GTiff")
any_surface_water_raster = raster(paste0("data/surface_water/occurrence.tif"))
...
transition_raster = raster(paste0(box_data_path, "transition.tif"))
writeRaster(transition_raster, paste0(here::here(), "/data/surface_water/transition.tif"), "GTiff")
permanent_water_raster = seasonal_surface_water_raster = ephemeral_surface_water_raster = raster(paste0("data/surface_water/transition.tif"))
