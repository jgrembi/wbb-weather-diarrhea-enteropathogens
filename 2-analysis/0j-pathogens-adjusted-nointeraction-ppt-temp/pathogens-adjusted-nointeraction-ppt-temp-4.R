...
analysis = "pathogens-adjusted-nointeraction-ppt-temp"
...
write.table(pathogens_tbl_message, paste0(here::here(),"/2-analysis/0j-pathogens-adjusted-nointeraction-ppt-temp/pathogens-nointeraction-tbl_message_4.csv"), sep = ',', row.names = FALSE )
...
fit_pathogens_gam = function(pathogens_tbl_row) {
  ...
  x <- fit_gam_interaction(df = d_pathogens,
                           ...
                           interaction_term = as.character(pathogens_tbl_row[["interaction_term"]]),
                           interaction = FALSE,
  ...
  # }
  pathogens_tbl_message = read.csv(paste0(here::here(),"/2-analysis/0j-pathogens-adjusted-nointeraction-ppt-temp/pathogens-nointeraction-tbl_message_4.csv"))
