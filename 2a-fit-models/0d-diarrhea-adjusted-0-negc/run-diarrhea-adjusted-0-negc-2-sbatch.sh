...
#SBATCH --job-name=run-diarrhea-adjusted-0-negc-2
#SBATCH --begin=now
...
cd /oak/stanford/groups/relman/users/jgrembi/wash/wbb-weather-diarrhea-enteropathogens/2a-fit-models/0d-diarrhea-adjusted-0-negc/

R CMD BATCH --no-save diarrhea-adjusted-0-negc-2.R 
