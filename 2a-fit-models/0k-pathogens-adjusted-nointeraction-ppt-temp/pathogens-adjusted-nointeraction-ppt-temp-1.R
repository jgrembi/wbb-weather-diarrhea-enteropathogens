...
write.table(pathogens_tbl_message, paste0(here::here(),"/2-analysis/0j-pathogens-adjusted-nointeraction-ppt-temp/pathogens-nointeraction-tbl_message_1.csv"), sep = ',', row.names = FALSE )
...
fit_pathogens_gam = function(pathogens_tbl_row) {
  ...
  # }
  pathogens_tbl_message = read.csv(paste0(here::here(),"/2-analysis/0j-pathogens-adjusted-nointeraction-ppt-temp/pathogens-nointeraction-tbl_message_1.csv"))
